from gym_minigrid.minigrid import Door, Floor, Goal, Grid, MiniGridEnv, Switch
from gym_minigrid.register import register


class SwitchEnvTest(MiniGridEnv):
    """
    ...
    def _gen_grid(self, width, height):
        ...
        self.put_obj(Door("purple", is_locked=True), splitIdx, doorIdx)
...
class SwitchTest10x10(SwitchEnvTest):
    def __init__(self):
        super().__init__(size=10)


register(
    id="MiniGrid-SwitchTest-10x10-v0", entry_point="gym_minigrid.envs:SwitchEnvTest"
)
