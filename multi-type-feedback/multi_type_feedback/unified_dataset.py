...
class MultiHeadDataModule(pytorch_lightning.LightningDataModule):
    ...
    def __init__(
        self, feedback_buffers: Dict[str, List[Any]], batch_size: int = 32, val_split: float = 0.2, ensemble_count: int = 4
    ):
        super().__init__()
    ...
    def train_dataloader(self):
        ...
        return DataLoader(combined_train, batch_size=self.ensemble_count, shuffle=True, pin_memory=True, drop_last=True)
    ...
    def val_dataloader(self):
        ...
        return DataLoader(combined_val, batch_size=self.ensemble_count, shuffle=False, pin_memory=True, drop_last=True)
