...
class ContinuousWandbCallback(BaseCallback):
    ...
    def __init__(
        ...
        if self.model_save_path is not None:
            ...
            assert self.model_save_freq == 0, "to use the `model_save_freq` you must set the `model_save_path` parameter"
    ...
    def _on_step(self) -> bool:
        ...
        if hasattr(self.model, "logger") and hasattr(self.model.logger, "name_to_value"):
            ...
            if metrics:
                ...
                wandb_metrics = {key: value for key, value in metrics.items() if isinstance(value, (int, float))}
