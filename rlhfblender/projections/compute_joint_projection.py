...
class JointProjectionComputer:
    ...
    def preprocess_all_data(
        self, 
        episode_data_list: List[Dict[str, np.ndarray]]
    ...
    def save_joint_projection(
        self, 
        handler: ProjectionHandler,
        checkpoint_projections: Dict[int, np.ndarray]
    ) -> str:
        """
...
def main():
    ...
    parser.add_argument("--checkpoints", type=str, required=True, 
                       help="Comma-separated list of checkpoint steps (e.g., '1000,2000,3000')")
    ...
    parser.add_argument("--n-neighbors", type=int, default=15, 
                       help="Number of neighbors for UMAP (if applicable)")
