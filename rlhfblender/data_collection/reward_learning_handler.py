...
class RewardModelHandler:
    ...
    def submit_feedback(self, feedback: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "success",
                "message": "Feedback submitted and training started",
    ...
    def _start_training_process(self, feedback_file: Path):
        ...
        cmd = [
            ...
            "--env", self.exp.env_id if self.exp else "HalfCheetah-v5",
            "--algorithm", self.exp.algorithm if self.exp else "sac",
            "--seed", str(self.exp.seed if self.exp else 0),
        ]
    ...
    def get_training_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.process:
                ...
                if not status_data["process_running"] and status_data["status"] not in [TrainingStatus.COMPLETED, TrainingStatus.FAILED]:
    ...
    def initial_episode_collection(self, num_episodes: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                "--random-policy", "true",  # Use random policy for initial collection
            ]
            ...
            if episodes_file.exists():
                ...
                return {
                    "status": "success",
                    "message": f"Collected {len(episodes)} initial episodes",
                    "episodes": episodes
                }
            else:
                ...
                return {
                    "status": "error",
                    "message": "Failed to collect initial episodes",
                    "episodes": []
                }
            ...
            return {
                "status": "error",
                "message": f"Failed to collect initial episodes: {str(e)}",
                "episodes": []
            }
    ...
    def evaluate_reward_model(self, model_path: str, num_episodes: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            if eval_file.exists():
                ...
                return {
                    "status": "success",
                    "message": f"Evaluated model on {num_episodes} episodes",
                    **results
                }
            else:
    ...
    def collect_episodes_with_model(self, model_path: str, num_episodes: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                "--env", self.exp.env_id if self.exp else "HalfCheetah-v5",
                "--num-episodes", str(num_episodes),
                "--random-policy", "false",  # Use the reward model
                "--reward-model-path", model_path,
            ]
            ...
            if episodes_file.exists():
                ...
                return {
                    "status": "success",
                    "message": f"Collected {len(episodes)} episodes with model",
                    "episodes": episodes
                }
            else:
                ...
                return {
                    "status": "error",
                    "message": "Failed to collect episodes with model",
                    "episodes": []
                }
            ...
            return {
                "status": "error",
                "message": f"Failed to collect episodes with model: {str(e)}",
                "episodes": []
            }


    def predict_uncertainty_for_states(
        self, 
        ...
        try:
            ...
            cmd = [
                ...
                "--session-dir", str(self.session_dir),
                "--model-path", model_path,
                "--states-file", str(self.session_dir / "states.json"),
            ]
            ...
            if predictions_file.exists():
                ...
                return {
                    "status": "error",
                    "message": "Failed to predict uncertainties",
                    "predictions": []
                }
            ...
            return {
                "status": "error",
                "message": f"Failed to predict uncertainties: {str(e)}",
                "predictions": []
            }