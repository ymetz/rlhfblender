...
# Uses SEEDS_FB (2 seeds) to limit job count.
    ...
    # ── Corrective feedback (agent vs expert — adaptive signal) ────────────
    "J_film_corr      |--rl-steps 2000|--num-phases 10|--feedback-budget 500|--uncertainty-penalty 0.0|--reward-epochs 20|--initial-feedback  50||--feedback-types corrective||--reward-model-type film-unified --reward-normalization quantile"
    "J_film_comp_corr |--rl-steps 2000|--num-phases 10|--feedback-budget 500|--uncertainty-penalty 0.0|--reward-epochs 20|--initial-feedback  50||--feedback-types comparative corrective||--reward-model-type film-unified --reward-normalization quantile"
    "J_film_ec_corr   |--rl-steps 2000|--num-phases 10|--feedback-budget 500|--uncertainty-penalty 0.0|--reward-epochs 20|--initial-feedback  50||--feedback-types evaluative comparative corrective||--reward-model-type film-unified --reward-normalization quantile"
